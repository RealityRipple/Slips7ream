...
Public Class Expander
  ...
  <DefaultValue(True), Description("Indicates whether the component is in the open state.")>
  ...
  <DefaultValue("Expander"), Browsable(True), EditorBrowsable(True), Description("The text associated with the control.")>
