...
Partial Class frmUpdateProps
  ...
  End Sub
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmUpdateProps))
    ...
    Me.lblReleaseType = New System.Windows.Forms.Label()
    Me.txtReleaseType = New System.Windows.Forms.TextBox()
    ...
    Me.pnlUpdateData.Controls.Add(Me.lblAppliesTo, 0, 8)
    Me.pnlUpdateData.Controls.Add(Me.txtAppliesTo, 1, 8)
    Me.pnlUpdateData.Controls.Add(Me.lblArchitecture, 0, 10)
    Me.pnlUpdateData.Controls.Add(Me.txtArchitecture, 1, 10)
    Me.pnlUpdateData.Controls.Add(Me.lblBuildDate, 0, 12)
    Me.pnlUpdateData.Controls.Add(Me.txtBuildDate, 1, 12)
    Me.pnlUpdateData.Controls.Add(Me.lblKBArticle, 0, 16)
    Me.pnlUpdateData.Controls.Add(Me.lblKBLink, 1, 16)
    Me.pnlUpdateData.Controls.Add(Me.cmdClose, 1, 18)
    Me.pnlUpdateData.Controls.Add(Me.lblName, 0, 0)
    Me.pnlUpdateData.Controls.Add(Me.txtName, 1, 0)
    Me.pnlUpdateData.Controls.Add(Me.lblVersion, 0, 14)
    Me.pnlUpdateData.Controls.Add(Me.txtVersion, 1, 14)
    Me.pnlUpdateData.Controls.Add(Me.lblReleaseType, 0, 6)
    Me.pnlUpdateData.Controls.Add(Me.txtReleaseType, 1, 6)
    ...
    Me.pnlUpdateData.RowCount = 19
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle())
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 11.11111!))
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle())
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 11.11111!))
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle())
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 11.11111!))
    ...
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 11.11111!))
    Me.pnlUpdateData.RowStyles.Add(New System.Windows.Forms.RowStyle())
    Me.pnlUpdateData.Size = New System.Drawing.Size(334, 266)
    ...
    Me.helpS7M.SetHelpString(Me.lblIdentity, resources.GetString("lblIdentity.HelpString"))
    ...
    Me.helpS7M.SetHelpString(Me.txtIdentity, resources.GetString("txtIdentity.HelpString"))
    ...
    Me.helpS7M.SetHelpString(Me.lblDisplayName, resources.GetString("lblDisplayName.HelpString"))
    ...
    Me.helpS7M.SetHelpString(Me.txtDisplayName, resources.GetString("txtDisplayName.HelpString"))
    ...
    Me.lblAppliesTo.Location = New System.Drawing.Point(3, 110)
    ...
    Me.txtAppliesTo.Location = New System.Drawing.Point(99, 107)
    ...
    Me.lblArchitecture.Location = New System.Drawing.Point(3, 136)
    ...
    Me.lblArchitecture.TabIndex = 10
    ...
    Me.helpS7M.SetHelpString(Me.txtArchitecture, "The OS Architecture this update is designed for. SLIPS7REAM uses this value to de" & _
        "termine if it should be integrated into an Image Package.")
    Me.txtArchitecture.Location = New System.Drawing.Point(99, 133)
    ...
    Me.txtArchitecture.TabIndex = 11
    '
    'lblBuildDate
    '
    ...
    Me.lblBuildDate.Location = New System.Drawing.Point(3, 162)
    ...
    Me.txtBuildDate.Location = New System.Drawing.Point(99, 159)
    ...
    Me.lblKBArticle.Location = New System.Drawing.Point(3, 214)
    ...
    Me.cmdClose.Location = New System.Drawing.Point(251, 238)
    ...
    Me.lblVersion.Location = New System.Drawing.Point(3, 188)
    ...
    Me.helpS7M.SetHelpString(Me.txtVersion, "The Version of most Windows Updates is 6.1.Update_Major.Update_Minor to identify " & _
        "them as updates for Windows 7 (or other numbers for other versions).")
    Me.txtVersion.Location = New System.Drawing.Point(99, 185)
    ...
    Me.lblReleaseType.Size = New System.Drawing.Size(76, 13)
    Me.lblReleaseType.TabIndex = 6
    Me.lblReleaseType.Text = "Release Type:"
    '
    'txtReleaseType
    '
    ...
    Me.helpS7M.SetShowHelp(Me.txtReleaseType, True)
    Me.txtReleaseType.Size = New System.Drawing.Size(232, 20)
    Me.txtReleaseType.TabIndex = 7
    '
    'helpS7M
    '
  ...
  Friend WithEvents lblReleaseType As System.Windows.Forms.Label
  Friend WithEvents txtReleaseType As System.Windows.Forms.TextBox
End Class
